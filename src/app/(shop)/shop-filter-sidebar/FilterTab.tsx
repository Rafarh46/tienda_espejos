...
import { brandData, sizeData2, vendorData, categoryData } from '@src/common/shop/filterData'
...
const FilterTab = () => {
    ...
    const [range, setRange] = useState([32, 60]);
    ...
    const handleRangeChange = (value: number | number[]) => {
        if (Array.isArray(value)) {
            ...
            // Handle single value case (though it's not expected here for range sliders)
                ...
                <div className={`p-4 filter-box ${open === false ? "" : "d-none"} mt-4`}>
                    <Row className="m-sm-2 g-4 g-sm-2">
                        ...
                        <Col sm={6} lg={3}>
                            ...
                            <div className="filter-title"></div>
                            <div className="mt-3">
                                {sizeData2.map((item: any, index: number) => {
                                    return (
                                        <div key={index} className="form-check mb-2">
                                            <input className="form-check-input" type="checkbox" id="flexCheckChecked11" />
                                            <label className="form-check-label" htmlFor="flexCheckChecked11" style={{ cursor: "pointer" }}>
                                                {item.size} <span className="ms-1 text-muted">{item.number}</span>
                                            </label>
                                        </div>
                                    )
                                })}
                        ...
                        <Col sm={6} lg={3}>
                            ...
                            <div className="mt-3 filter-category">
                                {categoryData.map((item: any, index: number) => {
                                    return (
                                        <div key={index} className="form-check pt-2 mb-2">
                                            <input className="form-check-input" type="checkbox" value="" id="cate" />
                        ...
                        <Col sm={6} lg={3}>
                            ...
                            <form className="form-inline my-2 my-lg-4 filter-search me-3">
                                ...
                                <button className="btn btn-custom-dark  fw-medium min-w-150 mt-3">FILTER</button>
                            </form>
                        </Col>
